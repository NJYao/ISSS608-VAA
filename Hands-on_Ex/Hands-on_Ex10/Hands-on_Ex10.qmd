...
Load the CoffeeChain.rds file by clicking on it and Load the R object with the name coffeechain:

![](images/clipboard-1037191157.png)
...
ggplot(sales_report, aes(x=Month, y=Sales)) + 
  ...
  geom_text(data = ends, aes(label = Sales), hjust = 0.5, nudge_x = 0.5) +
