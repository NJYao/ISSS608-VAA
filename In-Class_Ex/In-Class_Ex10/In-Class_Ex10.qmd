---
title: "Investments VIs"
author: "Ng Jin Yao"
format: dashboard
execute: 
  echo: false #Dashboard usually don't want to let user see code, set to false
editor: visual
---
...
#package good for finance tidyquant R Package, quant finance style financial analysis - allow extraction of yahoo finance data
#glue to combine visualisations together
```
...
daily_prices <- SGStock %>%
  ...
  tq_get(get = "stock.prices",
         from = "2025-01-01",
         to = Sys.Date() #to call the data and based on system date of own local pc
         ) 
...
```{r}
#| content: valuebox  #with a hashbar to tell its a yml object
#| title: "Opening Price"
list(color = "primary",
...
```{r}
#Plotting stock price line chart and the control chart +-3 standard deviation from the mean
