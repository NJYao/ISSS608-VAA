...
2.  X-axis labels are tilted in an angle to help with readability

3.  Soft gridlines with a lighter shade than the bar fills are used that do not distract from the main bar graph data
